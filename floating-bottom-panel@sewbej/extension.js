const UUID = "floating-bottom-panel@sewbej";
...
MyExtension.prototype = {
    _init: function(meta) {
        ...
        this.settings.bind("gap-size", "gapSize", this.on_settings_changed);
    ...
    make_transparent: function(panel, transparent) {
        ...
        if (transparent) {
            ...
            panel.actor.set_style(`padding: 0px ${gap}px ${gap}px ${gap}px;`);
        } else {
    ...
    on_panel_height_changed: function() {
        global.log(`floating-bottom-panel: panel-height = ${this.panel_height}`);
    ...
    on_window_maximized_changed: function() {
        global.log(`floating-bottom-panel: window-maximized = ${this.enablePanelSize}`);
...
var Callbacks = {
    btn_website_pressed: function() {
        Gio.app_info_launch_default_for_uri("https://www.opendesktop.org/p/2225956", null);
    },
    btn_issue_pressed: function() {
        Gio.app_info_launch_default_for_uri("https://github.com/sewbej/floating-panels/issues", null);
    },
    btn_donate_pressed: function() {
        Gio.app_info_launch_default_for_uri("https://ko-fi.com/sewbej", null);
    },
};
