...
MyExtension.prototype = {
    ...
    make_transparent: function(panel, transparent) {
        ...
        if (transparent) {
            ...
            panel.actor.set_style(`padding: ${gap}px ${gap}px ${gap}px 0px;`);
        } else {
    ...
    on_panel_height_changed: function() {
        global.log(`floating-right-panel: panel-height = ${this.panel_height}`);
    ...
    on_window_maximized_changed: function() {
        global.log(`floating-right-panel: window-maximized = ${this.enablePanelSize}`);
